...
let taskListDOM = function (task) {
    ...
    let tasks = document.createElement('a')
    ...
    tasks.setAttribute('href', `\edit.html#${task.id}`)
...
let newTaskDOM = function (newToDo) {
    ...
    let newTask = {
        ...
        id: id,
        //5/4/2019 when a new task is created the created date and updated date will be the exact same
        createdAt: timestamp,
        updatedAt: timestamp,
        title: newToDo,
        completed: false,
